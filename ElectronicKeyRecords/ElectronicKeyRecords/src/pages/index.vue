<template>
  <section class="splash">
    <div>
      <!-- <app-logo/> -->
      <img style="width:300px" class="animated flipInY" src="../assets/electronic-key.png" />
      <h1 class="title">
        ElectronicKeyRecords
      </h1>
      <h2 class="subtitle">
      ...
      <div class="mt-5">
        ...
        <p class="pt-3">You are not authenticated.</p> -->
          ...
          <link-button href="/signup" sm outline-secondary class="ml-2">Request Access</link-button>
        <!-- </div> -->
      </div>
